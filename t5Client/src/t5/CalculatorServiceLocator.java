...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements t5.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:10120/t5/services/Calculator";
    ...
    public t5.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public t5.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t5.CalculatorSoapBindingStub _stub = new t5.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t5.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                t5.CalculatorSoapBindingStub _stub = new t5.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://t5", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://t5", "Calculator"));
        }
